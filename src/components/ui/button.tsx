  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gold text-background font-semibold tracking-wide uppercase hover:bg-gold-light shadow-[0_4px_30px_-5px_hsl(38_70%_50%_/_0.4)] hover:shadow-[0_8px_40px_-5px_hsl(38_70%_50%_/_0.5)] rounded-none border-0",
        heroOutline: "border-2 border-gold text-gold font-semibold tracking-wide uppercase hover:bg-gold hover:text-background rounded-none transition-all duration-300",
      },
      size: {
